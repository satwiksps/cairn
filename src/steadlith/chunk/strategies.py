"""Pure baseline chunking strategies used by Steadlith's comparisons."""
...
from steadlith._legacy_wire import V1_CHUNKER_PARAMS_DOMAIN
...
from steadlith.content.hashing import canonical_json_hash, chunk_content_hash
...
def _make_chunks(
    ...
    *,
    ...
    params_hash = canonical_json_hash(params, domain=V1_CHUNKER_PARAMS_DOMAIN)
