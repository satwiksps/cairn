...
from steadlith._legacy_wire import V1_WORD_PERSON
from steadlith.chunk.params import CHUNKER_ID, CDCParams
...
from steadlith.content.hashing import chunk_content_hash
...
def _word_symbol(text: str, paragraph_before: bool) -> int:
    ...
    digest = hashlib.blake2b(marker + text.encode("utf-8"), digest_size=8, person=V1_WORD_PERSON)
