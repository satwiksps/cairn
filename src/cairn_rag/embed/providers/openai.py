"""Optional OpenAI embedding provider (installed with ``cairn-rag[openai]``)."""
    ...
    def __init__(
        ...
        *,
        ...
        try:
            ...
            raise ProviderError(
                "OpenAI support is not installed; run 'pip install cairn-rag[openai]'"
            ) from exc
        ...
        self._params_hash = hashlib.sha256(b"cairn:embedding-params:v1\0" + payload).hexdigest()
