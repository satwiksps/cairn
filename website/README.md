...
Set `NEXT_PUBLIC_SITE_URL` to the canonical `https://` production URL. GitHub links default to the upstream `https://github.com/satwiksps/cairn`; forks can override them with `NEXT_PUBLIC_REPOSITORY_URL`.
